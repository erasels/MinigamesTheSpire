...
public class board3 extends AbstractBoard {
    ...
    public void init() {
        ...
        if(tiles.get(0) instanceof GameTile){
            ...
            //r3
            ((GameTile) tiles.get(12)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(13)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(14)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(15)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(16)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((InfoTile) tiles.get(17)).getInfoHorizontal(tiles, 12);

            //r4
            ((GameTile) tiles.get(18)).setGoldAmount(goldConstants.GOLD_SCORE_HIGH);
            ...
            //r5
            ((GameTile) tiles.get(24)).setGoldAmount(goldConstants.GOLD_SCORE_HIGH);
            ...
            ((GameTile) tiles.get(27)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
