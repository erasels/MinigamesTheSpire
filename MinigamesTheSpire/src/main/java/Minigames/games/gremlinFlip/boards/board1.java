...
public class board1 extends AbstractBoard {
    ...
    public void init() {
        ...
        if(tiles.get(0) instanceof GameTile){
            ...
            ((GameTile) tiles.get(10)).setGoldAmount(goldConstants.GOLD_SCORE_HIGH);
            ...
            ((GameTile) tiles.get(14)).setEnemy();
            ...
            //r4
            ((GameTile) tiles.get(18)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(19)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(20)).setEnemy();
            ((GameTile) tiles.get(21)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(22)).setEnemy();
            ((InfoTile) tiles.get(23)).getInfoHorizontal(tiles, 18);

            //r5
            ((GameTile) tiles.get(24)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(25)).setEnemy();
