...
public class board4 extends AbstractBoard {
    ...
    public void init() {
        ...
        if(tiles.get(0) instanceof GameTile){
            ...
            //r2
            ((GameTile) tiles.get(6)).setEnemy();
            ((GameTile) tiles.get(7)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(8)).setGoldAmount(goldConstants.GOLD_SCORE_HIGH);
            ((GameTile) tiles.get(9)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(10)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ...
            //r4
            ((GameTile) tiles.get(18)).setEnemy();
            ...
            ((GameTile) tiles.get(21)).setEnemy();
            ...
            ((GameTile) tiles.get(28)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
