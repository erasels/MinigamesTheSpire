...
public class board6 extends AbstractBoard {
    ...
    public void init() {
        ...
        if(tiles.get(0) instanceof GameTile){
            ...
            ((GameTile) tiles.get(3)).setEnemy();
            ((GameTile) tiles.get(4)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ...
            ((GameTile) tiles.get(25)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
