...
public class board2 extends AbstractBoard {
    ...
    public void init() {
        ...
        if(tiles.get(0) instanceof GameTile){
            ...
            // r1
            ((GameTile) tiles.get(0)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(1)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(2)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(3)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(4)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((InfoTile) tiles.get(5)).getInfoHorizontal(tiles, 0);

            //r2
            ((GameTile) tiles.get(6)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(7)).setEnemy();
            ((GameTile) tiles.get(8)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(9)).setEnemy();
            ((GameTile) tiles.get(10)).setEnemy();
            ((InfoTile) tiles.get(11)).getInfoHorizontal(tiles, 6);

            //r3
            ((GameTile) tiles.get(12)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(13)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(14)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(15)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ...
            ((GameTile) tiles.get(19)).setEnemy();
            ((GameTile) tiles.get(20)).setEnemy();
            ...
            //r5
            ((GameTile) tiles.get(24)).setGoldAmount(goldConstants.GOLD_SCORE_MEDIUM);
            ((GameTile) tiles.get(25)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(26)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
            ((GameTile) tiles.get(27)).setEnemy();
            ((GameTile) tiles.get(28)).setGoldAmount(goldConstants.GOLD_SCORE_LOW);
